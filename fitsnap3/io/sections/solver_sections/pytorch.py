...
from ...input import config # Use this to prevent unused pytorch/mliap from loading.


if "PYTORCH" in config.tmp_config.sections():
    try:
        import torch
    ...
    #print("No PYTORCH section in input.")
    pass
